...
{
    assert(FIRST_CHALLENGE_INDEX <= challenge_index && challenge_index <= LAST_CHALLENGE_INDEX);
    printf("====================================================\n");
    ...
    int simple_utilization_percentage = (int)(100.0 * (simple_stats.allocated_size - simple_stats.freed_size) / (simple_stats.mmap_size - simple_stats.munmap_size));
    int my_utilization_percentage = (int)(100.0 * (my_stats.allocated_size - my_stats.freed_size) / (my_stats.mmap_size - my_stats.munmap_size));
